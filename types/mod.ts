...
export namespace Position {
  ...
  export function is(value: any): value is Position {
    ...
    return Is.objectLiteral(candidate) && Is.number(candidate.line) &&
...
export namespace Range {
  ...
  export function create(
    ...
    if (
      Is.number(one) && Is.number(two) && Is.number(three) && Is.number(four)
    ) {
      return {
...
export namespace DiagnosticRelatedInformation {
  ...
  export function is(value: any): value is DiagnosticRelatedInformation {
    let candidate: DiagnosticRelatedInformation =
...
export namespace Diagnostic {
  ...
  export function is(value: any): value is Diagnostic {
    ...
    return Is.defined(candidate) &&
      ...
      (Is.number(candidate.code) || Is.string(candidate.code) ||
...
export class WorkspaceChange {
  ...
  /**
	 ...
	 */
  public get edit(): WorkspaceEdit | undefined {
...
export namespace TextDocumentItem {
  ...
  export function is(value: any): value is TextDocumentItem {
    ...
    return Is.defined(candidate) && Is.string(candidate.uri) &&
      Is.string(candidate.languageId) && Is.number(candidate.version) &&
...
export namespace FormattingOptions {
  ...
  export function is(value: any): value is FormattingOptions {
    ...
    return Is.defined(candidate) && Is.number(candidate.tabSize) &&
