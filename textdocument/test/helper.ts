...
import { Position, Range, TextEdit, TextDocument } from "../mod.ts";
...
export namespace Positions {
  ...
  export function afterSubstring(
...
export namespace Ranges {
  export function create(
    ...
    return {
      start: Positions.create(startLine, startCharacter),
      end: Positions.create(endLine, endCharacter),
    };
  }
  ...
  export function forSubstring(document: TextDocument, subText: string): Range {
    ...
    return {
      ...
      end: document.positionAt(index + subText.length),
    };
  }
